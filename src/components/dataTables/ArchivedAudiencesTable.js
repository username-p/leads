        ...
        {data?.map((item, index) => {
          return (
            <div key={index} className="grid hover-grid">
              <h5 className="data-h5">{item?.name} </h5>
              <h5 className="data-h5">{item?.description}</h5>
              <h5 className="data-h5">{item?.leads?.length} lead(s)</h5>
              <h5 className="data-h5">{item?.createdAt}</h5>
...
export default ArchivedAudiencesTable;
